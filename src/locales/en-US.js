export default {
  ...
  general: {
    ...
    connectivityPollIntervalUnit: 'sec',
    modelUsageRefreshInterval: 'Chart Refresh Interval',
    modelUsageRefreshIntervalDesc: 'Auto-refresh interval for the model usage chart',
    modelUsageRefreshIntervalUnit: 'min',
    balanceRefreshInterval: 'Balance Refresh Interval',
    balanceRefreshIntervalDesc: 'Time interval for periodic API token balance queries',
    balanceRefreshIntervalUnit: 'min',
    projectSessionRefreshInterval: 'Project Session Refresh Interval',
    projectSessionRefreshIntervalDesc: 'Auto-refresh interval for the project session list and session details',
    projectSessionRefreshIntervalUnit: 'min',
    balanceProviderRules: 'Supplier Detection Rules',
    balanceProviderRulesDesc: 'Match baseUrl keywords to auto-detect balance supplier. Supports custom supplier name and balance endpoint',
    balanceProviderRulesAdd: 'Add Supplier',
    ...
    balanceUsedFieldPlaceholder: 'e.g. data.total_used',
    balanceTotalField: 'Total Field',
    balanceTotalFieldPlaceholder: 'e.g. data.total_granted',
    balanceUnit: 'Display Unit',
    balanceUnitPlaceholder: 'e.g. $, ¥ or leave blank',
    balanceUnitNotSet: 'Not set',
    delete: 'Delete',
    ...
    shellTimeoutDesc: 'Shell tool execution timeout',
    shellTimeoutUnit: 'ms',
