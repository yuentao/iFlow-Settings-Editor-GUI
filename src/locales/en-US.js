export default {
  ...
  general: {
    ...
    balanceProviderRules: 'Provider Auto-Detection Rules',
    balanceProviderRulesDesc: 'Match baseUrl keywords to identify the balance provider (lower priority than manual selection)',
    balanceProviderRulesAdd: 'Add Rule',
    balanceRulePattern: 'Keyword (e.g. buzz)',
