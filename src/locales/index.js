export default {
  ...
  general: {
    ...
    shellTimeoutDesc: 'Shell 工具执行的超时时间',
    shellTimeoutUnit: '毫秒',
    connectivityPollInterval: '连通性检测间隔',
    connectivityPollIntervalDesc: '定期检测 API 配置连通性的时间间隔',
    connectivityPollIntervalUnit: '秒',
    modelUsageRefreshInterval: '图表刷新间隔',
    modelUsageRefreshIntervalDesc: '模型使用趋势图表的自动刷新间隔',
    modelUsageRefreshIntervalUnit: '分钟',
    balanceRefreshInterval: '余额刷新间隔',
    balanceRefreshIntervalDesc: '定期查询 API Token 余额的时间间隔',
    balanceRefreshIntervalUnit: '分钟',
    projectSessionRefreshInterval: '项目会话刷新间隔',
    projectSessionRefreshIntervalDesc: '项目会话列表和会话详情的自动刷新间隔',
    projectSessionRefreshIntervalUnit: '分钟',
    balanceProviderRules: '供应商检测规则',
    balanceProviderRulesDesc: '根据 baseUrl 关键词自动匹配供应商，支持自定义供应商名称和余额查询接口',
    balanceProviderRulesAdd: '添加供应商',
    ...
    balanceUsedFieldPlaceholder: '如 data.total_used',
    balanceTotalField: '总量字段',
    balanceTotalFieldPlaceholder: '如 data.total_granted',
    balanceUnit: '显示单位',
    balanceUnitPlaceholder: '如 $、¥ 或留空',
    balanceUnitNotSet: '未配置',
    delete: '删除',
    approvalMode: '审批模式',
    approvalModeDesc: 'CLI 启动时默认模式',
    approvalModeYolo: 'YOLO',
    approvalModePlan: '计划',
    approvalModeAutoEdit: '智能',
  ...
  mcp: {
    title: 'MCP 服务器',
    description: '管理 iFlow CLI 的 MCP 服务器配置',
    serverList: '服务器列表',
    addServer: '添加服务器',
    editServer: '编辑服务器',
    edit: '编辑',
