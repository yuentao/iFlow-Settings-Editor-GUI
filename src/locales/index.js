export default {
  ...
  general: {
    ...
    balanceProviderRules: 'Provider 自动检测规则',
    balanceProviderRulesDesc: '根据 baseUrl 包含的关键词自动识别余额查询服务（优先级低于手动指定）',
    balanceProviderRulesAdd: '添加规则',
    balanceRulePattern: '关键词（如 buzz）',
    approvalMode: '审批模式',
