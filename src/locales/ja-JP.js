export default {
  ...
  general: {
    ...
    balanceProviderRules: 'Provider 自動検出ルール',
    balanceProviderRulesDesc: 'baseUrl のキーワードで残高照会サービスを自動識別（手動指定より優先度低）',
    balanceProviderRulesAdd: 'ルール追加',
    balanceRulePattern: 'キーワード（例：buzz）',
    excludeTools: '除外ツール',
    excludeToolsDesc:
